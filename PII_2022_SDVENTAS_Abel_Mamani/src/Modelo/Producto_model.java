    ...
    try {
        ...
        if (actualizar.execute(query)) {
            ...
            if (nuevo != null) {
                ...
                boolean debeActualizarPrecio = valorPrecio != precio;

                if (codPrecio > 0 && debeActualizarPrecio) {
                    if (registrarPrecio(nuevo.getCodigoProducto(), precio) && updatePrecioActual(codPrecio)) {
                        salida = true;
                    }
                } else {
                    salida = true;
